defmodule HelloPhoenixWeb.Router do
  ...
  scope "/", HelloPhoenixWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{HelloPhoenixWeb.UserAuth, :require_authenticated}] do
  ...
  scope "/", HelloPhoenixWeb do
    ...
    live_session :current_user,
      ...
      live "/messaging_conversations", ConversationLive.Index, :index
      live "/messaging_conversations/new", ConversationLive.Form, :new
      live "/messaging_conversations/:id", ConversationLive.Show, :show
      live "/messaging_conversations/:id/edit", ConversationLive.Form, :edit
    end
